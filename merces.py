...
def abrir_aplicacion_usuario():
    ...
    twitter_button = tk.Button(social_frame, text="Twitter", command=abrir_twitter, font=("Helvetica", 10, "bold"), bg="#1DA1F2", fg="white")
    twitter_button.pack(side="left", padx=5)

    instagram_button = tk.Button(social_frame, text="Instagram", command=abrir_instagram, font=("Helvetica", 10, "bold"), bg="#C13584", fg="white")
